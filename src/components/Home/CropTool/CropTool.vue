<template>
  <div>
      ...
      <div class="toolMain">
        <div ref="toolBox"
          ...
          <div class="tips" v-show="!drawImg.img">
            <el-button @click="chooseImg" type="warning" size="mini">Please choose Img</el-button>
          </div>
          <div
            v-show="drawImg.img"
            ...
            <div class="controlBox">
              <div class="selectArea">width:{{toolBox.width}} height:{{toolBox.height}} (x:{{toolBox.boxMove.moveTo.x}},y:{{toolBox.boxMove.moveTo.y}})</div>
        ...
        <div class="toolBar">
          ...
          <el-form :inline="true">
            ...
            <el-form-item>
              <el-input clearable v-model="rate" placeholder="width/height"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </div>
    ...
    <el-button type="primary" @click="cropPicture">确定</el-button>
  </span>
    </el-dialog>
  </div>
</template>
    ...
    methods:{
      ...
      putImgToCanv:function(e){
        ...
        if(file) {
          ...
          this.$nextTick(()=>{
            let x = this.boxWidth/2 - this.toolBox.width;
            let y = this.boxHeight/2 - this.toolBox.height;
